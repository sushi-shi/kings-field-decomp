...
**Overall: 403 / 471 functions exact (85.56%) &middot; 56.34% exact-code coverage &middot; 98.38% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 304 / 362 (83.98%) | 362 | 98.18% |
| `OPEN.EXE` | 98 / 108 (90.74%) | 108 | 99.46% |
| **Total** | **403 / 471 (85.56%)** | **471** | **98.38%** |
