...
**Overall: 425 / 471 functions exact (90.23%) &middot; 65.98% exact-code coverage &middot; 98.96% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 318 / 362 (87.85%) | 362 | 98.81% |
| `OPEN.EXE` | 106 / 108 (98.15%) | 108 | 99.74% |
| **Total** | **425 / 471 (90.23%)** | **471** | **98.96%** |
