...
**Overall: 242 / 734 functions exact (32.97%) &middot; 16.22% exact-code coverage &middot; 26.42% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 225 / 492 (45.73%) | 267 | 34.92% |
| `OPEN.EXE` | 16 / 241 (6.64%) | 18 | 3.51% |
| **Total** | **242 / 734 (32.97%)** | **286** | **26.42%** |
