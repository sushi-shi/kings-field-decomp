...
**Overall: 362 / 471 functions exact (76.86%) &middot; 43.27% exact-code coverage &middot; 92.30% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 264 / 362 (72.93%) | 362 | 90.99% |
| `OPEN.EXE` | 97 / 108 (89.81%) | 108 | 99.27% |
| **Total** | **362 / 471 (76.86%)** | **471** | **92.30%** |
