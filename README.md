...
**Overall: 293 / 537 functions exact (54.56%) &middot; 31.30% exact-code coverage &middot; 71.57% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 276 / 388 (71.13%) | 387 | 87.72% |
| `OPEN.EXE` | 16 / 148 (10.81%) | 18 | 6.27% |
| **Total** | **293 / 537 (54.56%)** | **406** | **71.57%** |
