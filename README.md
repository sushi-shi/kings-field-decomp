...
**Overall: 459 / 471 functions exact (97.45%) &middot; 86.37% exact-code coverage &middot; 99.92% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 351 / 362 (96.96%) | 362 | 99.90% |
| `OPEN.EXE` | 107 / 108 (99.07%) | 108 | 99.99% |
| **Total** | **459 / 471 (97.45%)** | **471** | **99.92%** |
...
_Derived from ignored artifacts made by the retired mixed-tool probe. `kf link --compare-only` can refresh this comparison but cannot build an EXE._

**Overall (3/3 images): 73.66% island-aligned byte similarity &middot; 70.65% nonzero-byte similarity.**
...
| `GAME.EXE` | 13.65% | 74.17% | 71.10% | 22 / 41 |
| `OPEN.EXE` | 14.19% | 72.35% | 69.70% | 9 / 20 |
