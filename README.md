...
**Overall: 13 / 864 functions exact (1.50%) &middot; 0.08% exact-code coverage &middot; 0.13% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 0 / 1 (0.00%) | 0 | 0.00% |
| `GAME.EXE` | 13 / 557 (2.33%) | 19 | 0.18% |
| `OPEN.EXE` | 0 / 306 (0.00%) | 0 | 0.00% |
| **Total** | **13 / 864 (1.50%)** | **19** | **0.13%** |
