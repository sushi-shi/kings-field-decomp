...
**Overall: 376 / 471 functions exact (79.83%) &middot; 44.82% exact-code coverage &middot; 91.84% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 278 / 362 (76.80%) | 362 | 90.44% |
| `OPEN.EXE` | 97 / 108 (89.81%) | 108 | 99.27% |
| **Total** | **376 / 471 (79.83%)** | **471** | **91.84%** |
