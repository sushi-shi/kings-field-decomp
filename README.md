...
**Overall: 395 / 471 functions exact (83.86%) &middot; 50.68% exact-code coverage &middot; 97.98% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 296 / 362 (81.77%) | 362 | 97.70% |
| `OPEN.EXE` | 98 / 108 (90.74%) | 108 | 99.46% |
| **Total** | **395 / 471 (83.86%)** | **471** | **97.98%** |
