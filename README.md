...
**Overall: 287 / 509 functions exact (56.39%) &middot; 33.06% exact-code coverage &middot; 75.54% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 270 / 374 (72.19%) | 374 | 89.27% |
| `OPEN.EXE` | 16 / 134 (11.94%) | 18 | 8.06% |
| **Total** | **287 / 509 (56.39%)** | **393** | **75.54%** |
