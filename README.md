...
**Overall: 220 / 734 functions exact (29.97%) &middot; 15.92% exact-code coverage &middot; 26.05% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 203 / 492 (41.26%) | 243 | 34.42% |
| `OPEN.EXE` | 16 / 241 (6.64%) | 18 | 3.51% |
| **Total** | **220 / 734 (29.97%)** | **262** | **26.05%** |
