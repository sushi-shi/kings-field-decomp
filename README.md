...
**Overall: 431 / 471 functions exact (91.51%) &middot; 70.09% exact-code coverage &middot; 99.01% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 324 / 362 (89.50%) | 362 | 98.87% |
| `OPEN.EXE` | 106 / 108 (98.15%) | 108 | 99.74% |
| **Total** | **431 / 471 (91.51%)** | **471** | **99.01%** |
