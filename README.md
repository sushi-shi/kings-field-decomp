...
**Overall: 399 / 471 functions exact (84.71%) &middot; 52.52% exact-code coverage &middot; 98.26% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 300 / 362 (82.87%) | 362 | 98.03% |
| `OPEN.EXE` | 98 / 108 (90.74%) | 108 | 99.46% |
| **Total** | **399 / 471 (84.71%)** | **471** | **98.26%** |
