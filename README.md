...
**Overall: 427 / 471 functions exact (90.66%) &middot; 67.45% exact-code coverage &middot; 98.96% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 320 / 362 (88.40%) | 362 | 98.81% |
| `OPEN.EXE` | 106 / 108 (98.15%) | 108 | 99.74% |
| **Total** | **427 / 471 (90.66%)** | **471** | **98.96%** |
