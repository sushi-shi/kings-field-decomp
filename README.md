...
**Overall: 369 / 471 functions exact (78.34%) &middot; 43.85% exact-code coverage &middot; 91.66% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 271 / 362 (74.86%) | 362 | 90.22% |
| `OPEN.EXE` | 97 / 108 (89.81%) | 108 | 99.27% |
| **Total** | **369 / 471 (78.34%)** | **471** | **91.66%** |
