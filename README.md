...
**Overall: 400 / 471 functions exact (84.93%) &middot; 53.23% exact-code coverage &middot; 98.29% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 301 / 362 (83.15%) | 362 | 98.07% |
| `OPEN.EXE` | 98 / 108 (90.74%) | 108 | 99.46% |
| **Total** | **400 / 471 (84.93%)** | **471** | **98.29%** |
