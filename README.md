...
**Overall: 458 / 471 functions exact (97.24%) &middot; 85.62% exact-code coverage &middot; 99.91% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 350 / 362 (96.69%) | 362 | 99.89% |
| `OPEN.EXE` | 107 / 108 (99.07%) | 108 | 99.99% |
| **Total** | **458 / 471 (97.24%)** | **471** | **99.91%** |
