...
**Overall: 386 / 471 functions exact (81.95%) &middot; 47.65% exact-code coverage &middot; 94.07% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 288 / 362 (79.56%) | 362 | 93.09% |
| `OPEN.EXE` | 97 / 108 (89.81%) | 108 | 99.27% |
| **Total** | **386 / 471 (81.95%)** | **471** | **94.07%** |
