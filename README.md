...
**Overall: 373 / 471 functions exact (79.19%) &middot; 44.39% exact-code coverage &middot; 91.81% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 275 / 362 (75.97%) | 362 | 90.41% |
| `OPEN.EXE` | 97 / 108 (89.81%) | 108 | 99.27% |
| **Total** | **373 / 471 (79.19%)** | **471** | **91.81%** |
