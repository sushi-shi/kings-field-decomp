...
**Overall: 383 / 471 functions exact (81.32%) &middot; 46.92% exact-code coverage &middot; 92.81% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 285 / 362 (78.73%) | 362 | 91.60% |
| `OPEN.EXE` | 97 / 108 (89.81%) | 108 | 99.27% |
| **Total** | **383 / 471 (81.32%)** | **471** | **92.81%** |
