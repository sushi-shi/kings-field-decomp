...
**Overall: 391 / 471 functions exact (83.01%) &middot; 50.07% exact-code coverage &middot; 97.16% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 292 / 362 (80.66%) | 362 | 96.73% |
| `OPEN.EXE` | 98 / 108 (90.74%) | 108 | 99.46% |
| **Total** | **391 / 471 (83.01%)** | **471** | **97.16%** |
