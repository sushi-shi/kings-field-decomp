...
**Overall: 375 / 471 functions exact (79.62%) &middot; 44.55% exact-code coverage &middot; 91.83% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 277 / 362 (76.52%) | 362 | 90.43% |
| `OPEN.EXE` | 97 / 108 (89.81%) | 108 | 99.27% |
| **Total** | **375 / 471 (79.62%)** | **471** | **91.83%** |
