...
**Overall: 460 / 471 functions exact (97.66%) &middot; 87.60% exact-code coverage &middot; 99.93% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 352 / 362 (97.24%) | 362 | 99.91% |
| `OPEN.EXE` | 107 / 108 (99.07%) | 108 | 99.99% |
| **Total** | **460 / 471 (97.66%)** | **471** | **99.93%** |
