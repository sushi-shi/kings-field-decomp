...
**Overall: 398 / 471 functions exact (84.50%) &middot; 52.07% exact-code coverage &middot; 98.06% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 299 / 362 (82.60%) | 362 | 97.80% |
| `OPEN.EXE` | 98 / 108 (90.74%) | 108 | 99.46% |
| **Total** | **398 / 471 (84.50%)** | **471** | **98.06%** |
