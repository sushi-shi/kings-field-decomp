...
**Overall: 417 / 471 functions exact (88.54%) &middot; 61.36% exact-code coverage &middot; 98.91% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 315 / 362 (87.02%) | 362 | 98.78% |
| `OPEN.EXE` | 101 / 108 (93.52%) | 108 | 99.58% |
| **Total** | **417 / 471 (88.54%)** | **471** | **98.91%** |
