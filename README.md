...
**Overall: 13 / 1,092 functions exact (1.19%) &middot; 0.07% exact-code coverage &middot; 0.15% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 0 / 1 (0.00%) | 0 | 0.00% |
| `GAME.EXE` | 13 / 671 (1.94%) | 22 | 0.22% |
| `OPEN.EXE` | 0 / 420 (0.00%) | 0 | 0.00% |
| **Total** | **13 / 1,092 (1.19%)** | **22** | **0.15%** |
