...
**Overall: 439 / 471 functions exact (93.21%) &middot; 73.32% exact-code coverage &middot; 99.20% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 332 / 362 (91.71%) | 362 | 99.09% |
| `OPEN.EXE` | 106 / 108 (98.15%) | 108 | 99.74% |
| **Total** | **439 / 471 (93.21%)** | **471** | **99.20%** |
