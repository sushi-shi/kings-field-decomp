...
**Overall: 387 / 471 functions exact (82.17%) &middot; 48.14% exact-code coverage &middot; 96.51% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 289 / 362 (79.83%) | 362 | 95.99% |
| `OPEN.EXE` | 97 / 108 (89.81%) | 108 | 99.27% |
| **Total** | **387 / 471 (82.17%)** | **471** | **96.51%** |
