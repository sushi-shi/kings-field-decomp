...
**Overall: 341 / 485 functions exact (70.31%) &middot; 39.21% exact-code coverage &middot; 83.94% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 260 / 362 (71.82%) | 362 | 89.96% |
| `OPEN.EXE` | 80 / 122 (65.57%) | 88 | 53.96% |
| **Total** | **341 / 485 (70.31%)** | **451** | **83.94%** |
