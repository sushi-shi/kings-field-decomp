...
**Overall: 402 / 471 functions exact (85.35%) &middot; 55.86% exact-code coverage &middot; 98.33% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 303 / 362 (83.70%) | 362 | 98.12% |
| `OPEN.EXE` | 98 / 108 (90.74%) | 108 | 99.46% |
| **Total** | **402 / 471 (85.35%)** | **471** | **98.33%** |
