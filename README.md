...
**Overall: 438 / 471 functions exact (92.99%) &middot; 73.05% exact-code coverage &middot; 99.17% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 331 / 362 (91.44%) | 362 | 99.06% |
| `OPEN.EXE` | 106 / 108 (98.15%) | 108 | 99.74% |
| **Total** | **438 / 471 (92.99%)** | **471** | **99.17%** |
