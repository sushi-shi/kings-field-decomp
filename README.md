...
**Overall: 377 / 471 functions exact (80.04%) &middot; 45.01% exact-code coverage &middot; 91.87% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 279 / 362 (77.07%) | 362 | 90.48% |
| `OPEN.EXE` | 97 / 108 (89.81%) | 108 | 99.27% |
| **Total** | **377 / 471 (80.04%)** | **471** | **91.87%** |
