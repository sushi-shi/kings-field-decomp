...
**Overall: 453 / 471 functions exact (96.18%) &middot; 82.60% exact-code coverage &middot; 99.90% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 345 / 362 (95.30%) | 362 | 99.88% |
| `OPEN.EXE` | 107 / 108 (99.07%) | 108 | 99.99% |
| **Total** | **453 / 471 (96.18%)** | **471** | **99.90%** |
