...
**Overall: 393 / 471 functions exact (83.44%) &middot; 50.37% exact-code coverage &middot; 97.47% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 294 / 362 (81.22%) | 362 | 97.10% |
| `OPEN.EXE` | 98 / 108 (90.74%) | 108 | 99.46% |
| **Total** | **393 / 471 (83.44%)** | **471** | **97.47%** |
