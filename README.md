...
**Overall: 394 / 471 functions exact (83.65%) &middot; 50.62% exact-code coverage &middot; 97.48% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 295 / 362 (81.49%) | 362 | 97.11% |
| `OPEN.EXE` | 98 / 108 (90.74%) | 108 | 99.46% |
| **Total** | **394 / 471 (83.65%)** | **471** | **97.48%** |
