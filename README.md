...
**Overall: 297 / 503 functions exact (59.05%) &middot; 34.42% exact-code coverage &middot; 77.32% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 267 / 371 (71.97%) | 371 | 89.49% |
| `OPEN.EXE` | 29 / 131 (22.14%) | 32 | 17.45% |
| **Total** | **297 / 503 (59.05%)** | **404** | **77.32%** |
