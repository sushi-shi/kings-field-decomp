...
**Overall: 401 / 471 functions exact (85.14%) &middot; 54.02% exact-code coverage &middot; 98.31% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 302 / 362 (83.43%) | 362 | 98.10% |
| `OPEN.EXE` | 98 / 108 (90.74%) | 108 | 99.46% |
| **Total** | **401 / 471 (85.14%)** | **471** | **98.31%** |
