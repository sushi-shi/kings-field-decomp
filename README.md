...
**Overall: 60 / 740 functions exact (8.11%) &middot; 1.53% exact-code coverage &middot; 3.37% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 59 / 495 (11.92%) | 93 | 4.53% |
| `OPEN.EXE` | 0 / 244 (0.00%) | 0 | 0.00% |
| **Total** | **60 / 740 (8.11%)** | **94** | **3.37%** |
