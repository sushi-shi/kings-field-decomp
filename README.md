...
**Overall: 299 / 548 functions exact (54.56%) &middot; 31.50% exact-code coverage &middot; 71.36% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 282 / 394 (71.57%) | 393 | 87.78% |
| `OPEN.EXE` | 16 / 153 (10.46%) | 18 | 6.12% |
| **Total** | **299 / 548 (54.56%)** | **412** | **71.36%** |
