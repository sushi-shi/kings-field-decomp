...
**Overall: 286 / 511 functions exact (55.97%) &middot; 32.78% exact-code coverage &middot; 73.94% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 269 / 375 (71.73%) | 374 | 87.56% |
| `OPEN.EXE` | 16 / 135 (11.85%) | 18 | 7.92% |
| **Total** | **286 / 511 (55.97%)** | **393** | **73.94%** |
