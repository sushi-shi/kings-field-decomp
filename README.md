...
**Overall: 390 / 471 functions exact (82.80%) &middot; 48.96% exact-code coverage &middot; 96.57% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 291 / 362 (80.39%) | 362 | 96.03% |
| `OPEN.EXE` | 98 / 108 (90.74%) | 108 | 99.46% |
| **Total** | **390 / 471 (82.80%)** | **471** | **96.57%** |
