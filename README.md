...
**Overall: 211 / 734 functions exact (28.75%) &middot; 15.80% exact-code coverage &middot; 25.93% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 194 / 492 (39.43%) | 234 | 34.25% |
| `OPEN.EXE` | 16 / 241 (6.64%) | 18 | 3.51% |
| **Total** | **211 / 734 (28.75%)** | **253** | **25.93%** |
