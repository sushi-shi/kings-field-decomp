...
**Overall: 459 / 471 functions exact (97.45%) &middot; 87.43% exact-code coverage &middot; 99.93% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 351 / 362 (96.96%) | 362 | 99.91% |
| `OPEN.EXE` | 107 / 108 (99.07%) | 108 | 99.99% |
| **Total** | **459 / 471 (97.45%)** | **471** | **99.93%** |
