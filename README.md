...
**Overall: 54 / 738 functions exact (7.32%) &middot; 1.13% exact-code coverage &middot; 1.44% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 0 / 1 (0.00%) | 0 | 0.00% |
| `GAME.EXE` | 54 / 494 (10.93%) | 71 | 1.99% |
| `OPEN.EXE` | 0 / 243 (0.00%) | 0 | 0.00% |
| **Total** | **54 / 738 (7.32%)** | **71** | **1.44%** |
