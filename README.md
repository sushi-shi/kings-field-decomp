...
**Overall: 424 / 471 functions exact (90.02%) &middot; 65.30% exact-code coverage &middot; 98.95% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 317 / 362 (87.57%) | 362 | 98.81% |
| `OPEN.EXE` | 106 / 108 (98.15%) | 108 | 99.74% |
| **Total** | **424 / 471 (90.02%)** | **471** | **98.95%** |
