...
**Overall: 408 / 471 functions exact (86.62%) &middot; 58.53% exact-code coverage &middot; 98.56% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 309 / 362 (85.36%) | 362 | 98.40% |
| `OPEN.EXE` | 98 / 108 (90.74%) | 108 | 99.46% |
| **Total** | **408 / 471 (86.62%)** | **471** | **98.56%** |
