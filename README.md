...
**Overall: 252 / 735 functions exact (34.29%) &middot; 17.30% exact-code coverage &middot; 29.60% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 235 / 493 (47.67%) | 284 | 39.19% |
| `OPEN.EXE` | 16 / 241 (6.64%) | 18 | 3.51% |
| **Total** | **252 / 735 (34.29%)** | **303** | **29.60%** |
