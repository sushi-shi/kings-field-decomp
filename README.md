...
**Overall: 410 / 471 functions exact (87.05%) &middot; 59.04% exact-code coverage &middot; 98.57% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 311 / 362 (85.91%) | 362 | 98.41% |
| `OPEN.EXE` | 98 / 108 (90.74%) | 108 | 99.46% |
| **Total** | **410 / 471 (87.05%)** | **471** | **98.57%** |
