...
**Overall: 197 / 734 functions exact (26.84%) &middot; 11.76% exact-code coverage &middot; 16.27% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 180 / 492 (36.59%) | 216 | 20.96% |
| `OPEN.EXE` | 16 / 241 (6.64%) | 18 | 3.51% |
| **Total** | **197 / 734 (26.84%)** | **235** | **16.27%** |
