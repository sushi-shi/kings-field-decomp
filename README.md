...
**Overall: 429 / 471 functions exact (91.08%) &middot; 68.70% exact-code coverage &middot; 98.97% fuzzy.**

| Image | Functions exact | Started | Fuzzy (overall) |
| :---- | --------------: | ------: | --------------: |
| `PSX.EXE` | 1 / 1 (100.00%) | 1 | 100.00% |
| `GAME.EXE` | 322 / 362 (88.95%) | 362 | 98.82% |
| `OPEN.EXE` | 106 / 108 (98.15%) | 108 | 99.74% |
| **Total** | **429 / 471 (91.08%)** | **471** | **98.97%** |
