...
Complete account of **101 numeric occurrences** in `map_event.c`,
...
| `map_restore_floor_state` | 177 | `0` | `if (item_stock[KF_ITEM_STOCK_PLAYER][KF_ITEM_DRAGON_SWORD] != 0 \|\| item_stock[KF_ITEM_STOCK_PLAYER][KF_ITEM_MOONLIGHT_SWORD] != 0` | Stock row zero and nonzero possession tests for the named Dragon Sword and Moonlight Sword; the script flag supplies the separate alternative. |
| `map_restore_floor_state` | 177 | `0` | `if (item_stock[KF_ITEM_STOCK_PLAYER][KF_ITEM_DRAGON_SWORD] != 0 \|\| item_stock[KF_ITEM_STOCK_PLAYER][KF_ITEM_MOONLIGHT_SWORD] != 0` | Stock row zero and nonzero possession tests for the named Dragon Sword and Moonlight Sword; the script flag supplies the separate alternative. |
