...
Complete per-occurrence account of **95 retained numeric literals** in
...
| `effect_projectile_update_3d` | 73 | `0` | `actor_apply_damage(collision & KF_COLLISION_DETAIL_MASK, 0, magic->damage_components[0],` | Packed actor index uses low-halfword mask; zero base power and component slot zero begin the damage call. The remaining slots preserve the established 0,2,1 physical-component order. |
| `effect_projectile_update_3d` | 73 | `0` | `actor_apply_damage(collision & KF_COLLISION_DETAIL_MASK, 0, magic->damage_components[0],` | Packed actor index uses low-halfword mask; zero base power and component slot zero begin the damage call. The remaining slots preserve the established 0,2,1 physical-component order. |
...
| `effect_projectile_update_2d` | 139 | `0` | `actor_apply_damage(collision & KF_COLLISION_DETAIL_MASK, 0, magic->damage_components[0],` | Packed actor index uses low-halfword mask; zero base power and component slot zero begin the damage call. The remaining slots preserve the established 0,2,1 physical-component order. |
| `effect_projectile_update_2d` | 139 | `0` | `actor_apply_damage(collision & KF_COLLISION_DETAIL_MASK, 0, magic->damage_components[0],` | Packed actor index uses low-halfword mask; zero base power and component slot zero begin the damage call. The remaining slots preserve the established 0,2,1 physical-component order. |
