...
Audit of the 2026-09-09 working-source snapshot before data-owner integration,
including the item-detail workspace
...
- At the audit snapshot, `kf inventory check` passes with **130 types and 868 fields**. It compares
