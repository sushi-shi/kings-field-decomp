...
| [matrix_rotation.c](../../src/shared/matrix_rotation.c) and its shared fragments | 82 | [complete math ledger](math-literal-ledger.md) | Count from the original complete unit; sharing preserves expressions. |
| [memory.c](../../src/shared/memory.c) | 11 | [complete allocator/startup ledger](allocator-startup-literal-ledger.md) | Current token/expression coverage verified; every occurrence has a reason. |
