...
| `actor_update_boss_death_sequence` | 845 | `0` | `0, KF_EFFECT_USE_PLAYER_MAGIC \| KF_EFFECT_COLLISION_TARGET_ACTORS_AND_PLAYER, KF_EFFECT_KIND_RADIAL_BLAST_ALTERNATE,` | Stored effect ID zero for the boss-death visual; separate from type and kind. |
