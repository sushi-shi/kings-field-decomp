...
| Magic selection | IDs 4/5/7/8 are Lightning Bolt/Fire Ball/Wind Cutter/Light Needle; spell6 is Fire Wall and uses the ground-branch effect. The [retail spell audit](game-spell-identities.md) propagates these identities. The two cone ranges `0x4e20` = 20000 use the shared 341-unit aim tolerance. |
