...
| `item_load_floor_placements` | 72 | `15` | `(rand() * item->facing_and_frame_count) >> 15;` | The linked rand result spans 0..32767; shifting the product by fifteen scales that fraction into the authored frame count. This is the random-range normalization, not an animation timing constant. |
