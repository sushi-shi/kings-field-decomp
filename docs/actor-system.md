...
declared in `include/kf/semantic_types.h` with exact `0x98`, `0x0a`, `0x03`,
and `0x48` size checks. Unknown bytes remain explicit padding. The currently
supported actor fields include
