...
| **total** | **378** | **291** | **246** | **116** | **88** | **1,119** |

The 1,119 rows comprise 1,093 named functions and 26 anonymous internal
...
41 `LIBETC`, four startup functions attributed to `NONE2.OBJ`, two from
