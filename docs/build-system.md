...
1 PSX, 673 GAME, and 422 OPEN functions. Only manifested units with real base
...
inputs unless `--dirty` is explicit. Normal builds may refresh ignored build
artifacts but never update committed progress automatically.
