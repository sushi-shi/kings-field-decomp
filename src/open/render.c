    ...
    const VECTOR *position, const SVECTOR *rotation)
{
    ...
    if (position != 0) {
        ...
        open_graphics_runtime.render_state.view_cell.x = open_graphics_runtime.render_state.view_position.vx / 2000;
        open_graphics_runtime.render_state.view_cell.z = open_graphics_runtime.render_state.view_position.vz / 2000;
    }
    if (rotation != 0) {
