...
typedef s16 KfEndingLightingPhase; enum {
    ENDING_LIGHT_TO_MIDPOINT = 0,
    ENDING_LIGHT_TO_GREEN = 1,
    ENDING_LIGHT_FINISHED = 2
};

typedef s16 KfEndingSequencePhase; enum {
...
typedef s16 KfEndingScrollState; enum {
    ENDING_SCROLL_WAIT_DISK = 0,
    ENDING_SCROLL_ACTIVE = 1
};

typedef s16 KfEndingScrollTick; enum {
...
void opening_scene3_run(void)
{
    ...
    do {
        lighting_set_color_matrix(
            &color_matrix_table[((s32)(KF_OPEN_COLOR_DEFAULT))],
            &color_matrix_table[((s32)(KF_OPEN_COLOR_BLACK))], blend);
        opening_render_frame(
            &opening_camera_path_state.position,
            &opening_camera_path_state.rotation);
        blend += OPENING_COLOR_FADE_STEP;
    ...
    for (;;) {
        ...
        case ENDING_LIGHT_TO_MIDPOINT:
            if (lighting_blend <= KF_FIXED12_ONE) {
                lighting_set_color_matrix(
                    &color_matrix_table[((s32)(KF_OPEN_COLOR_BLACK))],
                    &color_matrix_table[((s32)(KF_OPEN_COLOR_ENDING_MIDPOINT))], lighting_blend);
        ...
        case ENDING_LIGHT_TO_GREEN:
            if (lighting_blend <= KF_FIXED12_ONE) {
                lighting_set_color_matrix(
                    &color_matrix_table[((s32)(KF_OPEN_COLOR_ENDING_MIDPOINT))],
                    &color_matrix_table[((s32)(KF_OPEN_COLOR_ENDING_GREEN))], lighting_blend);
        ...
        if (scroll_state > ENDING_SCROLL_WAIT_DISK) {
            ...
            scroll_tick = ((KfEndingScrollTick)(((s16)(scroll_tick)) - 1));
