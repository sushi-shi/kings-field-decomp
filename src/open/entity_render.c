...
void opening_entity_render(KfOpeningEntity *entity)
{
    ...
    screen.vx = entity->position.vx - open_graphics_runtime.render_state.view_position.vx;
    screen.vy = entity->position.vy - open_graphics_runtime.render_state.view_position.vy;
    screen.vz = entity->position.vz - open_graphics_runtime.render_state.view_position.vz;
...
void render_floor_item(KfFloorItem *item)
{
    ...
    SetRotMatrix(&open_graphics_runtime.render_state.view_matrix);
    SetTransMatrix(&open_graphics_runtime.render_state.view_matrix);
    screen.vx = item->position_x - open_graphics_runtime.render_state.view_position.vx;
    screen.vy = item->position_y - open_graphics_runtime.render_state.view_position.vy;
    screen.vz = item->position_z - open_graphics_runtime.render_state.view_position.vz;
    RotTrans(&screen, (VECTOR *)&model.t, &flag);
