...
void display_adjust_vram_view(void)
{
    ...
    DrawSync(0);
    VSync(0);
    PutDispEnv(&open_graphics_runtime.display_disp_environments[((u8)(open_graphics_runtime.display_state.buffer_index))]);
    open_graphics_runtime.display_draw_environments[((u8)(open_graphics_runtime.display_state.buffer_index))].dfe = 0;
    PutDrawEnv(&open_graphics_runtime.display_draw_environments[((u8)(open_graphics_runtime.display_state.buffer_index))]);
    display = &open_graphics_runtime.display_disp_environments[((u8)(open_graphics_runtime.display_state.buffer_index))];
    saved = display->disp;
    ...
    display->disp = saved;
    open_graphics_runtime.display_draw_environments[((u8)(open_graphics_runtime.display_state.buffer_index))].dfe = 1;
