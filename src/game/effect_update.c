...
void effect_projectile_update_3d(SVECTOR *probe_offset, s32 phase_limit)
{
    ...
    } else if (((u8)(life)) >= ((u8)(KF_EFFECT_HAZARD_RISE_FIRST)) && ((s16)(phase_limit)) >= ((u8)(life))) {
...
void effect_projectile_update_2d(s32 orbit_radius, s32 phase_limit)
{
    ...
    } else if ((((u32)(life)) & 0xff) != ((u8)(KF_EFFECT_HAZARD_RUNNING)) && ((s16)(phase_limit)) >= (int)(((u32)(life)) & 0xff)) {
        record->position.vy -= EFFECT_HAZARD_RISE_STEP;
        record->phase++;
    }
}
...
void effect_spawn_ground_branch(u8 id, KfEffectRecord *parent_effect, s16 angle_offset, s32 branch_role)
{
    VECTOR position;
