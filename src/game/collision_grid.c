...
{
    s32 floor_height = -(((u8 *)&map_floor_height_grid)[cell_index] * KF_MAP_HEIGHT_STEP);

    if (((KfMapCellKind *)&map_collision_grid)[cell_index] == KF_MAP_CELL_STEP) {
        switch (((KfMapOrientation *)&map_cell_orientation_grid)[cell_index]) {
