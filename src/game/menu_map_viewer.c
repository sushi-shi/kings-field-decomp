...
void menu_map_viewer(s32 item_id)
{
    s32 frame = 0;
    ...
    for (;;) {
        ...
        AddPrim((void *)(game_graphics_runtime.display_state.ordering_table + MENU_MARKER_OT_DEPTH),
                (void *)(&poly_marker[((u8)(game_graphics_runtime.display_state.buffer_index))]));
        AddPrim((void *)(game_graphics_runtime.display_state.ordering_table + MENU_CONTENT_OT_DEPTH),
                (void *)(&poly_bg[((u8)(game_graphics_runtime.display_state.buffer_index))]));
