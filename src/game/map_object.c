...
void map_object_pool_trigger_link(u8 link_id)
{
    ...
    do {
        ...
        case KF_MAP_OBJECT_OP_RELEASE_LONG_SWING:
            ...
            break;
        default:
            if (map_object_state.definitions.entries[((u8)(object->object_id))].behavior_type < KF_MAP_OBJECT_OP_LINK_TRIGGER_END
    ...
    for (count = KF_MAP_OBJECT_CAPACITY; count != 0; object++, count--) {
        ...
        case KF_MAP_OBJECT_OP_PROJECTILE_EMITTER:
            ...
            case KF_MAP_OBJECT_BOSS_PROJECTILE_EMITTER:
                ...
                object->action_timer = ((KfMapObjectProgress)((rand() >> MAP_EMITTER_COUNTDOWN_RANDOM_SHIFT) + MAP_BOSS_EMITTER_COUNTDOWN_BASE));
                break;
            }
            } else {
                object->action_timer--;
