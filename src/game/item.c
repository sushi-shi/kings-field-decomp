    ...
    *count = 0;
    ...
    if (placements->item_id != 0xffff) {
        do {
            ...
            item->position_x = placements->tile_x * 2000 + placements->local_x;
            item->position_z = placements->tile_z * 2000 + placements->local_z;
            height = map_floor_height_grid[placements->tile_z][placements->tile_x] * 100;
