...
void actor_initialize(KfActor *actor)
{
    ...
    if (actor->slot_state == KF_ACTOR_SLOT_RESPAWNING
        ...
        actor->rotation.angles.y = ((u8)(actor->heading_quadrant)) * KF_ANGLE_QUARTER_TURN;
    } else {
...
KfActorAction actor_try_select_profiled_action(KfActorAction action, s32 distance, u16 effect_code, u16 chance)
{
