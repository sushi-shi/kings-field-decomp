...
void player_set_equipment_slot(KfObjectId item_id, KfEquipmentSlot slot)
{
    ...
    if (player_state.equipped_head_armor_id != KF_OBJECT_NONE) {
        player_state.equipped_head_armor_record = &armor_records.entries[((u8)(player_state.equipped_head_armor_id)) - ((u8)(KF_ITEM_IRON_MASK))];
    } else {
    ...
    if (player_state.equipped_body_armor_id != KF_OBJECT_NONE) {
        player_state.equipped_body_armor_record =
            &armor_records.entries[((u8)(player_state.equipped_body_armor_id)) - ((u8)(KF_ITEM_IRON_MASK))];
    } else {
    ...
    if (player_state.equipped_arm_armor_id != KF_OBJECT_NONE) {
        player_state.equipped_arm_armor_record =
            &armor_records.entries[((u8)(player_state.equipped_arm_armor_id)) - ((u8)(KF_ITEM_IRON_MASK))];
    } else {
    ...
    if (player_state.equipped_leg_armor_id != KF_OBJECT_NONE) {
        player_state.equipped_leg_armor_record =
            &armor_records.entries[((u8)(player_state.equipped_leg_armor_id)) - ((u8)(KF_ITEM_IRON_MASK))];
    } else {
    ...
    if (player_state.equipped_shield_id != KF_OBJECT_NONE) {
        player_state.equipped_shield_record =
            &armor_records.entries[((u8)(player_state.equipped_shield_id)) - ((u8)(KF_ITEM_IRON_MASK))];
    } else {
...
void player_equip_weapon(KfObjectId weapon_id)
{
    ...
    if (weapon_id != KF_OBJECT_NONE) {
        ...
        weapon_image_path_template[9] = '0' + ((u32)(weapon_id)) / 10;
        weapon_image_path_template[10] = '0' + ((u32)(weapon_id)) % 10;
