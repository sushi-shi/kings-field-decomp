...
extern KfEffectRecord *func_80036f44(u8 id, u8 type, u8 kind, VECTOR *position,
    SVECTOR *direction, ...);
...
void func_8003a2a0(void)
{
    ...
    case 8:
        ...
        if (player_state.selected_magic_id == 8) {
            ...
            func_80036f44(0xa, 0x11, player_state.selected_magic_id, &world_pos,
    ...
    case 6:
        ...
        if (target != 0) {
            func_80036f44(0xa, 0x13, player_state.selected_magic_id,
                          &target->position,
            ...
            func_80036f44(0xa, 0x13, player_state.selected_magic_id, &spawn,
                          (SVECTOR *)&player_state.camera_rotation, 0);
        }
        break;
    }
