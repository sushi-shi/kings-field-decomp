...
void map_event_refresh_dialogue_stage(KfMapEvent *event)
{
    if (event->dialogue.fields.stage_limit > event->dialogue.fields.stage) {
        if (((u8)(player_state.progress_state.highest_floor)) < event->dialogue.fields.stage_limit) {
            if (event->dialogue.fields.stage != ((u8)(player_state.progress_state.highest_floor))) {
                event->dialogue.fields.stage = ((u8)(player_state.progress_state.highest_floor));
            reset_dialogue_page:
