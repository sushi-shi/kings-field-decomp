...
void player_warp_change_floor(KfFloorId floor, u32 map_variant)
{
    VECTOR position;
...
void player_warp_same_floor(u32 map_variant, s32 cell_x, s32 cell_z)
{
    VECTOR position;
