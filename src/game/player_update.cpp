            ...
            if (player_state.weapon_magic_shots_remaining != 0) {
                ...
                if (player_state.vitals.current_mp >= record->mp_cost) {
                    ...
                    effect_pool_construct(10,
                        ...
                        &position,
                        launch_direction,
                        KfEffectHomingArguments{&player_state.camera_rotation, attachment, KF_EFFECT_SOUND_PLAY});
                    if (effect == KF_EFFECT_KIND_HOMING_PROJECTILE) {
                        ...
                        effect_pool_construct(10,
                            ...
                            &position,
                            launch_direction,
                            KfEffectHomingArguments{&effect_rotation.vector, attachment, KF_EFFECT_SOUND_SILENT});
