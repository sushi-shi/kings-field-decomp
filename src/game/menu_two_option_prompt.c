...
/*
 * A positioned label consumed by menu_draw_string / func_800291ec: the screen
...
extern void func_800291ec(const MenuGlyphString *point0,
...
s32 menu_two_option_prompt(s32 kind, s32 menu_id, s32 arg2, void *arg3)
{
    ...
    for (;;) {
        if (result != -99) {
            ...
            func_800291ec(&label_a, &label_b, selected, highlight);
            func_8002ac34();
            while (pad_read(1) != 0)
                ;
            return result;
