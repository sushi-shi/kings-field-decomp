...
void render_frame(const VECTOR *position_or_null, const SVECTOR *rotation_or_null)
{
    ...
    auxiliary_sprite->state = ((KfSpriteState)(((u8)(player_state.compass_enabled))));
    effect_sprites[KF_EFFECT_SPRITE_COMPASS].state = ((KfSpriteState)(((u8)(player_state.compass_enabled))));
