...
static SVECTOR player_damage_camera_offsets[((u8)(KF_PLAYER_DAMAGE_FRAME_END))] = {
    {0, 0, 0, 0},
    {-32, 0, -32, 0},
    {-64, 0, -64, 0},
    {-48, 0, -32, 0},
...
void player_update(void)
{
    ...
    if (PAD_PRESSED(input, player_previous_input, PADRdown)
        ...
        if (item >= 0) {
            player_use_item(((int)(item)));
        } else if (item == ((s32)(KF_MENU_RESULT_GAME_LOADED))) {
            pool_release_all();
            audio_close_vab();
        ...
        } else if (item == ((s32)(KF_MENU_RESULT_RETURN_TO_INTRO))) {
        ...
        if (player_state.weapon_magic_delay == PLAYER_WEAPON_MAGIC_READY) {
            if (player_state.weapon_magic_shots_remaining != 0) {
                ...
                case KF_ITEM_TRIPLE_FANG:
                    ...
                    record = &magic_records[((u8)(KF_EFFECT_KIND_HOMING_PROJECTILE))];
                ...
                case KF_ITEM_FLAME_SWORD:
                    ...
                    record = &magic_records[((u8)(KF_MAGIC_FIRE_BALL))];
                ...
                case KF_ITEM_MOONLIGHT_SWORD:
                    ...
                    record = &magic_records[((u8)(KF_EFFECT_KIND_RADIAL_BLAST))];
                ...
                case KF_ITEM_COLICHEMARDE:
                    ...
                    record = &magic_records[((u8)(KF_MAGIC_LIGHT_NEEDLE))];
                    player_state.weapon_magic_delay = PLAYER_WEAPON_MAGIC_READY;
                    break;
                default:
                cancel:
                ...
                if (player_state.vitals.current_mp >= record->mp_cost) {
                    ...
                    if ((effect == KF_MAGIC_FIRE_BALL || effect == KF_MAGIC_LIGHT_NEEDLE)
                        ...
                        effect_rotation.angles.y -= PLAYER_WEAPON_MAGIC_JITTER_BIAS
                            - (rand() >> PLAYER_WEAPON_MAGIC_RANDOM_SHIFT);
                        attachment = ((s32)(player_state.weapon_magic_shots_remaining & 1));
                    } else {
                        ...
                        if (target == NULL) {
                            ...
                            attachment = ((s32)(target - actor_state.actors));
                        }
                    }
                    ...
                    effect_pool_construct(
                        ...
                        &position, launch_direction, (&player_state.camera_rotation), (attachment), (KF_EFFECT_SOUND_PLAY));
                    if (effect == KF_EFFECT_KIND_HOMING_PROJECTILE) {
                        ...
                        effect_pool_construct(
                            ...
                            KF_EFFECT_KIND_HOMING_PROJECTILE, &position, launch_direction, (&effect_rotation.vector), (attachment), (KF_EFFECT_SOUND_SILENT));
    ...
    if (player_state.update_state != KF_PLAYER_UPDATE_NORMAL
        ...
        if (player_state.update_state >= KF_PLAYER_DAMAGE_FRAME_END) {
            ...
            player_state.view_rotation_offset = player_damage_camera_offsets[((u8)(KF_PLAYER_UPDATE_NORMAL))];
            if (player_state.vitals.current_hp == 0) {
                player_death_begin();
            }
        } else {
            player_state.view_rotation_offset = player_damage_camera_offsets[((u8)(player_state.update_state))];
