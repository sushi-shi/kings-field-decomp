...
void render_actor(KfActor *actor)
{
    ...
    screen.vx = actor->position.vx - game_graphics_runtime.render_state.view_position.vx;
    screen.vy = actor->position.vy - game_graphics_runtime.render_state.view_position.vy;
    screen.vz = actor->position.vz - game_graphics_runtime.render_state.view_position.vz;
...
void render_map_object(KfMapObject *object)
{
    ...
    SetRotMatrix(&game_graphics_runtime.render_state.view_matrix);
    SetTransMatrix(&game_graphics_runtime.render_state.view_matrix);
    screen.vx = object->position.vx - game_graphics_runtime.render_state.view_position.vx;
    screen.vy = object->position.vy - game_graphics_runtime.render_state.view_position.vy;
    screen.vz = object->position.vz - game_graphics_runtime.render_state.view_position.vz;
    RotTrans(&screen, (VECTOR *)&model.t, &flag);
