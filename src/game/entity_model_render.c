...
void render_map_object(KfMapObject *object)
{
    ...
    id = object->object_id;
    switch (map_object_state.definitions.entries[((u8)(object->object_id))].behavior_type) {
    ...
    tmd_select_object_vertices(((u16)(id)));
    tmd_project_vertices(tmd_get_object(((u16)(id)))->vertex_count);
    render_enqueue_tmd(((u16)(id)), depth);
}
