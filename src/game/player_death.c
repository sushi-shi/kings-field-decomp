...
void game_state_initialize(void)
{
    ...
    item_stock[((u8)(KF_ITEM_STOCK_PLAYER))][((u8)(KF_ITEM_SHORT_SWORD))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_PLAYER))][((u8)(KF_ITEM_MEDICINAL_HERB))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_FIRST_SHOP))][((u8)(KF_ITEM_SHORT_SWORD))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_FIRST_SHOP))][((u8)(KF_ITEM_BATTLE_AXE))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_FIRST_SHOP))][((u8)(KF_ITEM_KNIGHT_SWORD))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_FIRST_SHOP))][((u8)(KF_ITEM_IRON_MASK))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_FIRST_SHOP))][((u8)(KF_ITEM_KNIGHT_HELM))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_FIRST_SHOP))][((u8)(KF_ITEM_KNIGHT_PLATE))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_FIRST_SHOP))][((u8)(KF_ITEM_SMALL_SHIELD))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_FIRST_SHOP))][((u8)(KF_ITEM_KNIGHT_SHIELD))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_FIRST_SHOP))][((u8)(KF_ITEM_GAUNTLET))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_FIRST_SHOP))][((u8)(KF_ITEM_IRON_BOOTS))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_FIRST_SHOP))][((u8)(KF_ITEM_MEDICINAL_HERB))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_FIRST_SHOP))][((u8)(KF_ITEM_ANTIDOTE_HERB))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_FIRST_SHOP))][((u8)(KF_ITEM_RECOVERY_MEDICINE))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_FIRST_SHOP))][((u8)(KF_ITEM_DRAGON_KING_GRASS_FRUIT))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_KNIGHT_SWORD))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_COLICHEMARDE))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_CRESCENT_AXE))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_KNIGHT_HELM))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_GREAT_HELM))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_BREASTPLATE))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_FULL_PLATE))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_FIRE_MAIL))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_TOWER_SHIELD))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_LEG_GUARDS))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_MEDICINAL_HERB))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_ANTIDOTE_HERB))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_RECOVERY_MEDICINE))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_DRAGON_KING_GRASS_LEAF))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_DRAGON_KING_GRASS_FRUIT))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_LIGHT_RING))] = 1;
    item_stock[((u8)(KF_ITEM_STOCK_SECOND_SHOP))][((u8)(KF_ITEM_GOLD_CROSS))] = 1;
}
...
void player_death_restart(void)
{
    ...
    if (map_floor1_script.revival_enabled == KF_MAP_SCRIPT_SET && item_stock[((u8)(KF_ITEM_STOCK_PLAYER))][((u8)(KF_ITEM_DRAGON_KING_GRASS_FRUIT))] != 0) {
...
void player_recalculate_combat_stats(void)
{
    ...
    if (player_state.equipped_weapon_id != KF_OBJECT_NONE) {
        weapon = &weapon_records.entries[((u8)(player_state.equipped_weapon_id))];
    ...
    if (player_state.equipped_head_armor_id != KF_OBJECT_NONE) {
        armor = &armor_records.entries[((u8)(player_state.equipped_head_armor_id)) - ((u8)(KF_ITEM_IRON_MASK))];
    ...
    if (player_state.equipped_body_armor_id != KF_OBJECT_NONE) {
        armor = &armor_records.entries[((u8)(player_state.equipped_body_armor_id)) - ((u8)(KF_ITEM_IRON_MASK))];
        player_state.cutting_defense += armor->cutting_defense;
        player_state.cutting_defense += armor->cutting_defense;
        player_state.striking_defense += armor->striking_defense;
        player_state.piercing_defense += armor->piercing_defense;
    ...
    if (player_state.equipped_arm_armor_id != KF_OBJECT_NONE) {
        armor = &armor_records.entries[((u8)(player_state.equipped_arm_armor_id)) - ((u8)(KF_ITEM_IRON_MASK))];
        player_state.cutting_defense += armor->cutting_defense;
        player_state.cutting_defense += armor->cutting_defense;
        player_state.striking_defense += armor->striking_defense;
        player_state.piercing_defense += armor->piercing_defense;
    ...
    if (player_state.equipped_leg_armor_id != KF_OBJECT_NONE) {
        armor = &armor_records.entries[((u8)(player_state.equipped_leg_armor_id)) - ((u8)(KF_ITEM_IRON_MASK))];
        player_state.cutting_defense += armor->cutting_defense;
        player_state.cutting_defense += armor->cutting_defense;
        player_state.striking_defense += armor->striking_defense;
        player_state.piercing_defense += armor->piercing_defense;
    ...
    if (player_state.equipped_shield_id != KF_OBJECT_NONE) {
        armor = &armor_records.entries[((u8)(player_state.equipped_shield_id)) - ((u8)(KF_ITEM_IRON_MASK))];
        player_state.cutting_defense += armor->cutting_defense;
        player_state.cutting_defense += armor->cutting_defense;
        player_state.striking_defense += armor->striking_defense;
        player_state.piercing_defense += armor->piercing_defense;
    ...
    if (player_state.base_magic >= DISPOISON_REQUIRED_BASE_MAGIC && magic_records[((u8)(KF_MAGIC_HEALING))].learned != KF_MAGIC_UNLEARNED && magic_records[((u8)(KF_MAGIC_DISPOISON))].learned == KF_MAGIC_UNLEARNED) {
        magic_records[((u8)(KF_MAGIC_DISPOISON))].learned = KF_MAGIC_LEARNED;
        notify_enqueue(KF_NOTIFICATION_MAGIC_LEARNED);
    }
    if (player_state.base_magic >= FIRE_WALL_REQUIRED_BASE_MAGIC && magic_records[((u8)(KF_MAGIC_FIRE_WALL))].learned == KF_MAGIC_UNLEARNED) {
        magic_records[((u8)(KF_MAGIC_FIRE_WALL))].learned = KF_MAGIC_LEARNED;
        notify_enqueue(KF_NOTIFICATION_MAGIC_LEARNED);
    }
    if (player_state.base_magic >= LIGHTNING_BOLT_REQUIRED_BASE_MAGIC && magic_records[((u8)(KF_MAGIC_LIGHTNING_BOLT))].learned == KF_MAGIC_UNLEARNED) {
        magic_records[((u8)(KF_MAGIC_LIGHTNING_BOLT))].learned = KF_MAGIC_LEARNED;
        notify_enqueue(KF_NOTIFICATION_MAGIC_LEARNED);
    }
...
void player_select_magic(KfEffectKind magic_id)
{
    ...
    if (magic_id == KF_MAGIC_NONE) {
        ...
        player_state.selected_magic_record =
            &magic_records[((u8)(player_state.selected_magic_id))];
    }
}
