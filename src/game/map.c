...
extern u8 DAT_80069018[100][100];
extern u8 DAT_800668e8[100][100];
...
void map_apply_copy_region(u8 region_id)
{
    ...
    while (height-- != 0) {
        ...
        while (width-- != 0) {
            ...
            DAT_80069018[destination_z][destination_x] = DAT_80069018[source_z][source_x];
            map_collision_grid[destination_z][destination_x] =
                map_collision_grid[source_z][source_x];
            DAT_800668e8[destination_z][destination_x] = DAT_800668e8[source_z][source_x];
            destination_x++;
            source_x++;
        }
        source_z++;
