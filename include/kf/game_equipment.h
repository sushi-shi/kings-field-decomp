...
enum {
    ...
    KF_ARMOR_ITEM_FIRST = KF_ITEM_IRON_MASK,
    KF_WEAPON_ITEM_FIRST = KF_ITEM_SHORT_SWORD,
    KF_WEAPON_ITEM_END = KF_ITEM_IRON_MASK,
    KF_HEAD_ARMOR_ITEM_FIRST = KF_ITEM_IRON_MASK,
    KF_HEAD_ARMOR_ITEM_END = KF_ITEM_BREASTPLATE,
    KF_BODY_ARMOR_ITEM_FIRST = KF_ITEM_BREASTPLATE,
    KF_BODY_ARMOR_ITEM_END = KF_ITEM_SMALL_SHIELD,
    KF_SHIELD_ITEM_FIRST = KF_ITEM_SMALL_SHIELD,
    KF_SHIELD_ITEM_END = KF_ITEM_GAUNTLET,
    KF_ARM_ARMOR_ITEM_FIRST = KF_ITEM_GAUNTLET,
    KF_ARM_ARMOR_ITEM_END = KF_ITEM_IRON_BOOTS,
    KF_LEG_ARMOR_ITEM_FIRST = KF_ITEM_IRON_BOOTS,
    KF_LEG_ARMOR_ITEM_END = KF_ITEM_GOLD_COIN,
