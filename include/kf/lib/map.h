...
typedef u8 KfMapScriptFlag; enum {
    KF_MAP_SCRIPT_UNSET = 0,
    KF_MAP_SCRIPT_SET = 1
};

typedef u8 KfMapAreaTriggerStage; enum {
...
typedef u8 KfMapObjectOperation; enum {
...
typedef u8 KfMapCopyRegionId; enum {
...
typedef u16 KfMapObjectProgress; enum {
...
typedef u8 KfMapObjectDropSource; enum {
...
typedef u8 KfMapEventState; enum {
