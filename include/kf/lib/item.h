...
typedef u8 KfItemStockBank; enum {
...
typedef u16 KfFloorItemSpriteId; enum {
...
typedef u8 KfFloorItemFacing; enum {
...
typedef u8 KfFloorItemAppearance; enum {
...
#define floor_item_appearance(facing, frames) \
    ((facing) | ((frames) & ((u8)(KF_FLOOR_ITEM_APPEARANCE_FRAME_MASK))))
#define floor_item_facing(appearance) ((appearance) & ((u8)(KF_FLOOR_ITEM_APPEARANCE_FACING_MASK)))
...
static inline void floor_item_advance_frame(KfFloorItem *item)
{
    ...
    frame_count = ((u8)(item->facing_and_frame_count));
    item->animation_frame = next_frame;
    if ((next_frame & 0xff) >= (frame_count & ((u8)(KF_FLOOR_ITEM_APPEARANCE_FRAME_MASK)))) {
