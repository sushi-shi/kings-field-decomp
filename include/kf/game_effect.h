...
enum {
    KF_EFFECT_KIND_LIGHTNING_BOLT = KF_MAGIC_LIGHTNING_BOLT,
    KF_EFFECT_KIND_FIRE_BALL = KF_MAGIC_FIRE_BALL,
    KF_EFFECT_KIND_GROUND_BRANCH = KF_MAGIC_FIRE_WALL,
    KF_EFFECT_KIND_WIND_CUTTER = KF_MAGIC_WIND_CUTTER,
    KF_EFFECT_KIND_LIGHT_NEEDLE = KF_MAGIC_LIGHT_NEEDLE,
