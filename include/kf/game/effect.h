...
typedef u8 KfEffectBillboardId; enum {
...
typedef u8 KfEffectModelId; enum {
...
typedef int KfEffectKindArgument;

typedef u8 KfEffectType; enum {
...
typedef u8 KfEffectHomingMode; enum {
    KF_EFFECT_HOMING_WANDER = 0xff,
    KF_EFFECT_HOMING_PLAYER = 0xfe
};

typedef u16 KfEffectGroundBranchRole; enum {
...
enum {
    ...
    KF_EFFECT_EMERGE_DEPTH =
        (((u8)(KF_EFFECT_PROJECTILE_FALL)) - ((u8)(KF_EFFECT_PROJECTILE_EMERGE_FIRST))) * KF_EFFECT_EMERGE_Y_STEP,
...
typedef s32 KfEffectSoundRequest; enum {
...
extern void effect_spawn_ground_branch(u8 id, KfEffectRecord *parent_effect, s16 angle_offset, s32 branch_role);
