...
/* Actor movement and wandering events reject this authored flag-grid bit;
 * its meaning outside those query policies remains unresolved. */
enum { KF_COLLISION_CELL_BLOCKS_WANDER = 0x80 };
