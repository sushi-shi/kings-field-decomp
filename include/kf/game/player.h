...
typedef s32 KfPlayerOption; enum {
    KF_PLAYER_OPTION_OFF = 0,
    KF_PLAYER_OPTION_ON = 1
};

typedef u8 KfPlayerVerticalState; enum {
...
typedef s32 KfWarpShimmerMode; enum {
...
typedef u8 KfPlayerUpdateState; enum {
...
typedef u8 KfActorSpawnPermission; enum {
    KF_ACTOR_NEAR_SPAWN_FORBIDDEN = 0,
    KF_ACTOR_NEAR_SPAWN_ALLOWED = 1
};

typedef u8 KfWeaponAttackCharge; enum {
...
#define PLAYER_ITEM_IS_EQUIPPED(item_index) \
    ((item_index) == ((u8)(player_state.equipped_weapon_id)) || \
     (item_index) == ((u8)(player_state.equipped_head_armor_id)) || \
     (item_index) == ((u8)(player_state.equipped_body_armor_id)) || \
     (item_index) == ((u8)(player_state.equipped_shield_id)) || \
     (item_index) == ((u8)(player_state.equipped_arm_armor_id)) || \
     (item_index) == ((u8)(player_state.equipped_leg_armor_id)) || \
     (item_index) == ((u8)(player_state.equipped_accessory_id)))
...
extern void player_warp_change_floor(KfFloorId floor, u32 map_variant);
extern void player_warp_shimmer(KfWarpShimmerMode shimmer_mode, VECTOR *position);
extern void player_warp_shimmer_at_player(u32 shimmer_mode);
extern void player_warp_same_floor(u32 map_variant, s32 cell_x, s32 cell_z);
