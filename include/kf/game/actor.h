...
typedef u8 KfActorLifecycle; enum {
...
typedef u8 KfActorCullingMode; enum {
    KF_ACTOR_CULL_VISIBILITY_GRID = 0,
    KF_ACTOR_CULL_NEAR_SQUARE = 1
};

typedef u8 KfActorAction; enum {
...
typedef u8 KfActorActionProgress; enum {
...
typedef s32 KfActorMoveDirection; enum {
    KF_ACTOR_MOVE_BACKWARD = -1,
    KF_ACTOR_MOVE_FORWARD = 1
};

typedef s32 KfActorCollisionPolicy; enum {
    KF_ACTOR_COLLISION_STEER = 0,
    KF_ACTOR_COLLISION_STOP = 1
};

typedef s32 KfActorMoveResult; enum {
    KF_ACTOR_MOVE_SUCCEEDED = 0,
    KF_ACTOR_MOVE_BLOCKED = 1
};

typedef u8 KfActorVerticalState; enum {
...
typedef u8 KfActorCollisionState; enum {
...
typedef u8 KfActorHeadingQuadrant; enum {
...
extern KfActorAction actor_try_select_profiled_action(
    KfActorAction action, s32 distance, u16 effect_code, u16 chance);
