...
}; using enum KfObjectId;

enum class KfFloorItemSpriteId : u16 {
...
}; using enum KfFloorItemSpriteId;
...
enum class KfFloorItemFacing : u8 {
...
}; using enum KfFloorItemFacing;

enum class KfFloorItemAppearance : u8 {
    KF_FLOOR_ITEM_APPEARANCE_EMPTY = 0,
    KF_FLOOR_ITEM_APPEARANCE_FRAME_MASK = 0x0f,
    KF_FLOOR_ITEM_APPEARANCE_FACING_MASK = 0xf0
}; using enum KfFloorItemAppearance;
constexpr KfFloorItemAppearance operator|(KfFloorItemAppearance lhs, KfFloorItemAppearance rhs)
...
{
    return kf_enum_decode<KfFloorItemAppearance>(kf_enum_encode<u8>(facing) | (frames & kf_enum_encode<u8>(KF_FLOOR_ITEM_APPEARANCE_FRAME_MASK)));
}
constexpr KfFloorItemFacing floor_item_facing(KfFloorItemAppearance appearance)
{
    return kf_enum_decode<KfFloorItemFacing>(kf_enum_encode<u8>(appearance) & kf_enum_encode<u8>(KF_FLOOR_ITEM_APPEARANCE_FACING_MASK));
}
