...
enum {
    KF_ACTOR_ATTACK_CUTTING = KF_COMBAT_COMPONENT_CUTTING,
    KF_ACTOR_ATTACK_STRIKING = KF_COMBAT_COMPONENT_STRIKING,
    KF_ACTOR_ATTACK_PIERCING = KF_COMBAT_COMPONENT_PIERCING,
    KF_ACTOR_ATTACK_COMPONENT_COUNT = KF_COMBAT_PHYSICAL_COMPONENT_COUNT
};

enum {
    KF_ACTOR_DEFENSE_CUTTING = KF_COMBAT_COMPONENT_CUTTING,
    KF_ACTOR_DEFENSE_STRIKING = KF_COMBAT_COMPONENT_STRIKING,
    KF_ACTOR_DEFENSE_PIERCING = KF_COMBAT_COMPONENT_PIERCING,
    KF_ACTOR_DEFENSE_HOLY = KF_COMBAT_COMPONENT_HOLY,
    KF_ACTOR_DEFENSE_FIRE = KF_COMBAT_COMPONENT_FIRE,
    KF_ACTOR_DEFENSE_COMPONENT_COUNT = KF_COMBAT_COMPONENT_COUNT
};
