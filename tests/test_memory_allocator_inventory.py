...
PAIRS = (
    ...
    ("GAME.EXE", 0x8001AB08, "memory_set_allocation_mode", "void", "KfMemoryAllocationMode allocation_mode"),
    ...
    ("OPEN.EXE", 0x80015E2C, "memory_set_allocation_mode", "void", "KfMemoryAllocationMode allocation_mode"),
