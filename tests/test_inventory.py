...
class InventoryTests(unittest.TestCase):
    def test_curated_inventories_cover_the_wip_universe(self) -> None:
        ...
        self.assertEqual(counts["functions"], 708)
        self.assertEqual(counts["signatures_started"], 708)
        self.assertEqual(counts["typed_returns"], 708)
        self.assertEqual(counts["parameterized"], 478)
