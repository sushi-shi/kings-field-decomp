...
OWNERS = (
    ...
    ('game.player_update', 0x80055858, 'player_status_effect1_color_matrix', 32, 'static',
...
REFERENCES = (
    ...
    (0x800199BC, 0x80055858, 'player_status_effect1_color_matrix', 0),
    (0x800199F0, 0x80055858, 'player_status_effect1_color_matrix', 0),
