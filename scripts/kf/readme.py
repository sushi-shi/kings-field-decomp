...
def render_block(document: dict) -> str:
    ...
    return "\n".join((
        ...
        "## Match status",
        "",
        "_Auto-generated by `kf check` (the final `kf analyze` edge) and "
...
def render_executable_block(
    ...
    return '\n'.join((
        ...
        '',
        '_Derived from ignored outputs made by the native Psy-Q executable chain. '
        '`kf build` rebuilds them; `kf link --compare-only` refreshes only this comparison._',
        '',
        overall,
        '',
