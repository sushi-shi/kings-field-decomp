...
def _header_structure_layouts() -> dict[str, HeaderStructureLayout]:
    ...
    checked_headers = (
        REPO / "include/kf/lib/types.h",
        REPO / "include/kf/lib/memory_layout.h",
        REPO / "include/kf/game/combat.h",
        REPO / "include/kf/lib/overlay.h",
        REPO / "include/kf/lib/animation.h",
        REPO / "include/kf/lib/cd_file.h",
        REPO / "include/kf/lib/floor.h",
        REPO / "include/kf/lib/audio.h",
        REPO / "include/kf/lib/resources.h",
        REPO / "include/kf/lib/map_data.h",
        REPO / "include/kf/lib/memory.h",
        REPO / "include/kf/lib/math.h",
        REPO / "include/kf/game/player_status.h",
        REPO / "include/kf/game/actor.h",
        ...
        REPO / "include/kf/game/player.h",
        REPO / "include/kf/lib/render_types.h",
        REPO / "include/kf/lib/tmd.h",
        REPO / "include/kf/game/asset.h",
        REPO / "include/kf/game/render.h",
        REPO / "include/kf/lib/notify_types.h",
        REPO / "include/kf/game/notify.h",
        REPO / "include/kf/open/render.h",
        REPO / "include/kf/game/graphics.h",
        REPO / "include/kf/open/resources.h",
        REPO / "include/kf/game/save.h",
        REPO / "include/kf/game/menu.h",
        REPO / "include/kf/game/cd.h",
    )
